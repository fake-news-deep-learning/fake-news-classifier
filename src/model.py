...
def create_lstm_model(input_shape: Tuple) -> Model:
    ...
    model.add(layers.LSTM(64, input_shape=(300, 1), return_sequences=True, name='lstm_1'))
    model.add(layers.LSTM(32, input_shape=(300, 1), return_sequences=False, name='lstm_2'))
